...
threshold_yellow = (37, 100, -5, 127, 49, 127)#(0, 100, 1, 127, 49, 127)#(3, 100, 2, 127, 41, 127)#(3, 100, 3, 127, 47, 127)#(36, 100, 11, 127, 40, 127)#(36, 100, 1, 127, 40, 127)#(44, 100, 7, 127, 23, 127)#(45, 100, -128, 127, 37, 127)#
threshold_blue = (24, 54, -128, -2, -128, 6)#(33, 54, -128, -5, -128, 6)#(33, 55, -128, -5, -128, 16)#(33, 55, -128, -5, -128, 11)#(27, 47, -128, -3, -128, 7)#(16, 100, -128, -9, -128, 9)#(16, 100, -128, -15, -128, 19)#(0, 45, -128, -10, -128, 9)#(0, 52, -128, -13, -128, 13)#(0, 49, -128, -6, -128, 4)#(14, 26, -128, 2, -128, 3)#(20, 60, -128, -3, -128, 5)#(20, 70, -95, -4, -128, 6)##(14, 49, -128, -7, -128, 0)#(14, 49, -128, -7, -128, 0)#
x0 = 171
y0 = 135#135
r0 = 150#153
...
while(True):
    ...
    #####################################################FIND_BLOBS     38
    for yb in img.find_blobs([threshold_yellow], merge = True, margin = 50, pixel_threshold = 270, area_threshold = 260): #310 300
    ...
    mxBb = 0
    bblob = []
    for bb in img.find_blobs([threshold_blue], merge = True, margin = 70, pixel_threshold = 280, area_threshold = 250): #350        280

...
threshold_yellow = (45, 100, -128, 127, 37, 127)#(0, 100, -128, 116, 19, 127)#(0, 100, -128, 116, 28, 127)#(76, 100, -4, 32, 10, 74)#(68, 100, -8, 127, 18, 127)#(61, 100, -18, 127, 29, 127)#(71, 100, -19, 127, 29, 127)#(71, 100, -19, 127, 29, 127)#(54, 98, -18, 127, 12, 82)#(45, 98, -28, 127, 11, 127)#(52, 100, -23, 127, 20, 127)#(54, 100, -37, 127, 39, 127)#(55, 67, -23, 13, 12, 127)#(55, 100, -38, -8, 34, 127)#(0, 100, -46, 35, 30, 127)#(61, 100, -46, 35, 30, 127)#(61, 100, -38, -7, 35, 127)#(52, 100, -16, 127, 30, 127)#(52, 100, -24, 127, 22, 127)#(52, 100, -23, 127, 34, 127)#(52, 100, -30, -7, 31, 127)#(52, 100, -31, 127, 25, 127)#(52, 100, -36, 127, 31, 127)#(0, 100, -31, 127, 29, 127)#(0, 100, -37, 127, 26, 127)#(0, 100, -43, 127, 33, 127)#(0, 100, -43, 127, 44, 127)#(0, 100, -42, 127, 48, 127)#(0, 100, -34, 127, 39, 127)#(0, 100, -41, 127, 35, 127)#(54, 100, -26, 127, 24, 127)#(0, 100, -44, 127, 23, 127)#(0, 100, -43, 127, 32, 127)#(0, 100, -37, 127, 31, 127)#(47, 100, -35, 127, 44, 127)
threshold_blue = (35, 63, -128, 20, -128, -1)#(5, 88, -128, 21, -128, -15)#(5, 88, -128, 17, -128, -21)#(5, 88, -128, -5, -128, -3)#(20, 100, -99, 127, -128, -22)#(34, 100, -128, -7, -128, -11)#(0, 78, -41, 127, -128, -17)#(0, 78, -37, 127, -128, -28)#(0, 65, -128, 97, -128, -14)#(0, 65, -128, -14, -128, -19)#(0, 51, -128, -3, -128, -10)#(0, 40, -128, -4, -128, -6)#(0, 40, -128, -12, -128, -4)#(0, 100, -128, -19, -128, 4)#(0, 42, -128, -6, -128, -12)#(0, 55, -128, -11, -128, -14)#(0, 59, -128, -18, -128, -1)#(0, 36, -127, 82, -128, -12)#(0, 32, -127, 82, -128, -12)#(0, 39, -127, 82, -128, -18)#(0, 61, -128, 23, -128, -31)
x0 = 171
y0 = 135
r0 = 153 #150


# синие ворота видны в зеркале но они обрезаются окружностью
#       pix sm
arr = [[0, 0],
       [20, 11],
       [32, 15],
...
while(True):
    ...
    mxBb = 0
    bblob = []
    for bb in img.find_blobs([threshold_blue], merge = True, margin = 25, pixel_threshold = 280, area_threshold = 250): #350        280
